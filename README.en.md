...
> This project is IoTHunter and is unrelated to IoTBec. The built-in demo only performs passive metadata fingerprinting. It does not connect to a real device or send network probes. Confirm authorization before adding real-device, network, or destructive capabilities.
